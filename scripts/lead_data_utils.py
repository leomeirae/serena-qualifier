...
def normalize_lead_data(lead_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Normaliza todos os dados de um lead.
...
def extract_lead_from_message(message: str) -> Dict[str, Any]:
    """
    Extrai informações de lead de uma mensagem de texto.
...
if __name__ == "__main__":
    ...
    extracted = extract_lead_from_message(message)
