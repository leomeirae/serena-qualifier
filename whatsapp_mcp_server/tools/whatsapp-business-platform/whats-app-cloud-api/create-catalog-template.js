/**
 * Function to create a catalog template in WhatsApp Cloud API.
 *
...
/**
 * Tool configuration for creating a catalog template in WhatsApp Cloud API.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: 'Create a catalog template in WhatsApp Cloud API.',
      parameters: {
        type: 'object',
        properties: {
          name: {
