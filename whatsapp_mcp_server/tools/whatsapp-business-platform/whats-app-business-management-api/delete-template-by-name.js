/**
 * Function to delete a message template by name in the WhatsApp Business Management API.
 *
 * @param {Object} args - Arguments for the deletion.
 * @param {string} args.templateName - The name of the template to be deleted.
...
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: 'Delete a message template by name in the WhatsApp Business Management API.',
      parameters: {
        type: 'object',
        properties: {
          templateName: {
